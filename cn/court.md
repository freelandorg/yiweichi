...
>当你参考官方法院创建了自己的法院之后，那么您可以在DOTC发布卖单的时候，选择法院的时候，您不选择官方法院，而直接输入您的法院合约的地址。再发布订单即可。

>如果您希望您的法院出现在DOTC的法院列表当中，请联系电报@hayeklink，为了保护用户的交易安全，我们会审核您的资质以及代码是否安全。如果通过审核，我们就会将您的法院地址添加到法院列表，这样，您的法院就可以被其他用户所选用。

>链上法院是一个营利性的组织，它的生命力取决于它判决的速度，公正性，收费合理等等因素。

#### 适合经营法院的主体

>我们认为，一个具有公信力的律师事务所，法官，有名望的律师。都适合经营法院。如果您是律师，法官，请与我们联系，我们会提供技术支持帮助您实现法院合约。在区块链上开展判决服务业务。以获取利润。
